...
| --- | --- | --- |
| GET | `/v1/admin/analytics/overview` | игроки, регистрации, active5/15/60, DAU/WAU/MAU, бои за сутки, Week1/Week2/Week3, кланы |
| GET | `/v1/admin/analytics/players` | активность, proxy retention, уровни, playersInClan |
| GET | `/v1/admin/analytics/progression` | воронка по флагам дней 1–21, PvP unlock, босс, питомец, Week3 paths/social |
