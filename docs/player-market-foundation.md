...
Версия прототипа на момент foundation была **0.0.6**. С 0.0.7 рынок открыт игрокам (`docs/player-market-1.md`, `docs/auction-1.md`). Vel остаётся отдельной NPC-экономикой.
