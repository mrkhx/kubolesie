...
describe('admin analytics payloads', () => {
  ...
  it('builds a progression funnel from flags', async () => {
    ...
    expect(funnel.directContactReached.count).toBe(0);
    expect(funnel.zatvornikWins.count).toBe(0);
