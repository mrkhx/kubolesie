...
export const ITEM_TEMPLATES: Record<string, ItemTemplate> = {
  ...
  bronze_pickaxe: {
    ...
    description: 'Твёрже железа на жиле. Открывает серебро, золото и глубину.',
    rarity: 'UNCOMMON',
    slot: 'WEAPON',
    attackBonus: 5,
    minDamage: 4,
  ...
  bronze_axe: {
    ...
    description: 'Рубит увереннее железного. Не новый ярус дерева.',
    rarity: 'UNCOMMON',
    slot: 'WEAPON',
    attackBonus: 5,
    minDamage: 5,
  ...
  bronze_sword: {
    id: 'bronze_sword',
    name: 'Бронзовый меч',
    description: 'Чуть острее железа. Не золото и не сюжетный клинок.',
    rarity: 'UNCOMMON',
    slot: 'WEAPON',
    attackBonus: 7,
    minDamage: 7,
  ...
  deep_pickaxe: {
    id: 'deep_pickaxe',
    name: 'Жильная кирка',
    description: 'Глубинный кристалл на обухе. Поздний ярус добычи Куболесья.',
    rarity: 'RARE',
    slot: 'WEAPON',
    attackBonus: 6,
    minDamage: 5,
  ...
  iron_helmet: {
    id: 'iron_helmet',
    name: 'Железный шлем',
    description: 'Пять слитков. Держит лоб.',
    rarity: 'UNCOMMON',
    slot: 'HEAD',
    defenseBonus: 3,
  },
  iron_chest: {
    ...
    description: 'Восемь слитков. Тяжелее туники, легче смолы.',
    rarity: 'UNCOMMON',
    slot: 'CHEST',
    defenseBonus: 5,
  },
  iron_boots: {
    ...
    description: 'Четыре слитка. Держат ступню на осыпи.',
    rarity: 'UNCOMMON',
    slot: 'FEET',
    defenseBonus: 2,
  },
  ...
  bronze_chest: {
    ...
    description: 'Держит удар наравне со смолой, без смолы.',
    rarity: 'UNCOMMON',
    slot: 'CHEST',
    defenseBonus: 6,
  },
  bronze_boots: {
    ...
    description: 'Тяжелее железных. Шаг короче, щиколотка целее.',
    rarity: 'UNCOMMON',
    slot: 'FEET',
    defenseBonus: 3,
  },
  miner_lantern: {
    ...
    description: 'Медный крепёж и уголь. Свет в жиле. Чуть больше сил.',
    rarity: 'UNCOMMON',
    slot: 'AMULET',
    maxEnergyBonus: 1,
  },
  improved_lantern: {
    ...
    description: 'Серебро держит стекло. Свет ровнее, шаг длиннее.',
    rarity: 'RARE',
    slot: 'AMULET',
    maxEnergyBonus: 2,
    dodgeBonus: 2,
  ...
  silver_charm: {
    ...
    description: 'Редкий. Не сюжет. Чуть уводит удар в сторону.',
    rarity: 'RARE',
    slot: 'AMULET',
    defenseBonus: 1,
    dodgeBonus: 6,
  ...
  gold_seal: {
    ...
    description: 'Декоративная. Не осколок сети. Клан и витрина, не бой.',
    rarity: 'RARE',
  },
  gold_band: {
    id: 'gold_band',
    name: 'Золотой обод',
    description: 'Мягкий металл. Чуть больше сил. Не меч и не сюжетная печать.',
    rarity: 'RARE',
    slot: 'AMULET',
    maxEnergyBonus: 1,
  },
  copper_brace: {
    id: 'copper_brace',
    name: 'Медная стяжка',
    description: 'Крепёж и олово. Держит настил. Не новый ярус брони.',
    rarity: 'UNCOMMON',
    defenseBonus: 2,
  },
  deep_charm: {
    id: 'deep_charm',
    name: 'Жильный оберег',
    description: 'Кристалл глубины. Поздний. Не осколок печати.',
    rarity: 'RARE',
    slot: 'AMULET',
    defenseBonus: 3,
    dodgeBonus: 6,
