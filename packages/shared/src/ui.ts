...
const LABEL_REWRITE: Array<{ match: RegExp; label: string; color: ButtonColor }> = [
  ...
  { match: /ещё к лагерю/i, label: '🏕 Ещё к лагерю', color: 'primary' },
  { match: /^(пока )?к лагерю$/i, label: '🏕 К лагерю', color: 'primary' },
  { match: /ещё к затопленному стану/i, label: '🏕 Ещё к затопленному стану', color: 'primary' },
  { match: /затопленному стану/i, label: '🏕 К затопленному стану', color: 'primary' },
  { match: /^(пока |ещё )?к стану$/i, label: '🏕 К стану', color: 'primary' },
...
const ACTION_STYLE: Partial<Record<string, { emoji?: string; label?: string; color: ButtonColor }>> = {
  ...
  MARKET_ACT: { emoji: '🛒', color: 'primary' },
  JOB_ACT: { emoji: '💼', color: 'primary' },
  PROD_ACT: { emoji: '🏗', color: 'primary' },
  ...
  BEGIN_DAY_15: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_16: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_17: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_18: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_19: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_20: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_21: { emoji: '▶', color: 'positive' },
  COMPLETE_DAY_15: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_16: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_17: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_18: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_19: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_20: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_21: { emoji: '✅', color: 'positive' },
  FARM_ACT: { emoji: '🌾', color: 'positive' },
  WEEK2_ACT: { emoji: '🌫', color: 'primary' },
  WEEK3_ACT: { emoji: '🌿', color: 'primary' },
  BEGIN_DAY_22: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_23: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_24: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_25: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_26: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_27: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_28: { emoji: '▶', color: 'positive' },
  COMPLETE_DAY_22: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_23: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_24: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_25: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_26: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_27: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_28: { emoji: '✅', color: 'positive' },
  WEEK4_ACT: { emoji: '🍂', color: 'primary' },
  BEGIN_DAY_29: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_30: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_31: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_32: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_33: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_34: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_35: { emoji: '▶', color: 'positive' },
  COMPLETE_DAY_29: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_30: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_31: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_32: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_33: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_34: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_35: { emoji: '✅', color: 'positive' },
  WEEK5_ACT: { emoji: '💧', color: 'primary' },
  BEGIN_DAY_36: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_37: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_38: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_39: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_40: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_41: { emoji: '▶', color: 'positive' },
  BEGIN_DAY_42: { emoji: '▶', color: 'positive' },
  COMPLETE_DAY_36: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_37: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_38: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_39: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_40: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_41: { emoji: '✅', color: 'positive' },
  COMPLETE_DAY_42: { emoji: '✅', color: 'positive' },
  WEEK6_ACT: { emoji: '⛓', color: 'primary' },
...
const MENU_STYLE: Record<string, { label: string; color: ButtonColor }> = {
  ...
  rootwood: { label: '🌿 Чаща', color: 'primary' },
  grove: { label: '🌲 Роща', color: 'primary' },
  mechanism: { label: '⚙ Узел', color: 'primary' },
  seal3: { label: '🔷 Свод', color: 'primary' },
  trail: { label: '🍂 Тропа', color: 'primary' },
  hollow: { label: '🍂 Низина', color: 'primary' },
  warped: { label: '⚙ Узел', color: 'primary' },
  seal4: { label: '🔷 Свод', color: 'primary' },
  marsh: { label: '💧 Топь', color: 'primary' },
  basin: { label: '💧 Чаша', color: 'primary' },
  outpost: { label: '🏚 Стан', color: 'primary' },
  seal5: { label: '🔷 Свод', color: 'primary' },
  station: { label: '⛓ Пост', color: 'primary' },
  gallery: { label: '⛓ Галерея', color: 'primary' },
  switch: { label: '⚙ Рычаг', color: 'primary' },
  seal6: { label: '🔷 Свод', color: 'primary' },
  ...
  pvp_hub: { label: '⚔ PvP', color: 'negative' },
  pvp_history: { label: '📜 История', color: 'primary' },
  pvp_rewards: { label: '🎁 Награды', color: 'positive' },
  market: { label: '🛒 Рынок', color: 'primary' },
  market_buy: { label: '🔎 Купить', color: 'primary' },
  market_sell: { label: '➕ Продать', color: 'primary' },
  market_mine: { label: '📦 Мои лоты', color: 'primary' },
  market_auc: { label: '🔨 Аукцион', color: 'primary' },
  work: { label: '⚒ Хозяйство', color: 'primary' },
  jobs: { label: '💼 Работы', color: 'primary' },
  production: { label: '🏗 Дворы', color: 'primary' },
